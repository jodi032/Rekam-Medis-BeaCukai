...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="../assets/img/bea.png" />
      ...
      if($cek == 0){
        ...
        setTimeout(function() {
          swal({
            ...
            $_SESSION['username'] = $userid['pekerjaan'];
            header('location:../');
          }
        }
        ?>
              ...
              <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                  <div class="login-brand">
                    <img src="../assets/img/bea.png" alt="logo" width="120" class="shadow-light">
                  </div>
               ...
               <h5>Sistem Informasi Rekam Medis<h5>
                <center><p>Pegawai Bea Cukai Banjarmasin </p></center>
